...
require('lazy').setup({
  ...
  --
  {
    ...
    config = function()
      vim.g.aider_command = 'bash -c ''set -a; if [ -f "$HOME/.bash_profile" ]; then . "$HOME/.bash_profile"; fi; set +a; exec /home/cyrill/.local/bin/aider --vim --edit-format udiff-simple --no-attribute-author --no-attribute-committer --model gemini-2.5-pro-preview-03-25'''
