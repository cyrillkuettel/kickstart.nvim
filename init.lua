...
require('lazy').setup({
  ...
  },
  {
    ...
    config = function()
      ...
      vim.api.nvim_create_user_command('AutoImportBuffer', python_imports.auto_import_buffer, { desc = 'Auto-import all undefined symbols in buffer (single options only)' })
